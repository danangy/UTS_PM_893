...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      title: "UTS MOBILE DANANG YANURIANTO",
    ...
    return Scaffold(
      body: SafeArea(
        ...
        child: ListView(
          children: [
            Image.network(
              'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Oeschinen_Lake%2C_Kandersteg%2C_Switzerland_%28Unsplash%29.jpg/1184px-Oeschinen_Lake%2C_Kandersteg%2C_Switzerland_%28Unsplash%29.jpg',
              fit: BoxFit.fitWidth,
            ),
            Container(
